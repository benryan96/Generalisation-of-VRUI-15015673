...
namespace VRStandardAssets.Utils
{
    ...
    public class VREyeRaycaster : MonoBehaviour
    {
        ...
        [SerializeField] private LineRenderer m_LineRenderer = null; // Support for laser pointer
        public bool ShowLineRenderer = true;                         // Laser pointer visability
        [SerializeField] private Transform m_trackingSpace = null;   // Tracking Space
